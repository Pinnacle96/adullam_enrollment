    ...
    <div class="content-wrapper">
      ...
      <div class="content-body">
        <!-- Revenue, Hit Rate & Deals -->
                         <?php
$uid=$_SESSION['uid'];
$ret=mysqli_query($con,"select FirstName, LastName, middleName from tbluser where ID='$uid'");
...
<?php if($adsts==1) {?>
                      <h4 align="center">Your Application has been  Approved and you will recieved an Email from us</h4>
                    <?php } else if($adsts==2) {?>
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      ...
                      <h4 align="center">Your Application has been  Approved. Fee is also submitted</h4>
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      ...
                      <h4 align="center">Your Application has been  Proof and Please Submit your fee.</h4>
