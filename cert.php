...
<section class="w3l-contact-breadcrum">
  <div class="breadcrum-bg py-sm-5 py-4">
    <div class="container py-lg-3">
      <h2>Certificate in Theology</h2>
      <p><a href="index.php">Home</a> &nbsp; / &nbsp; Certificate in Theology</p>
    </div>
  </div>
</section>
...
<div class="container">
      <div class="row calltoaction-20-content">
        ...
        <!-- Text content -->
        <div class="col-lg-6 ">
          <h2 class="title">Certificate in Theology</h2>
          <ul>
            <li>
              <div class="content-box">
                <h5 class="description"><strong>WHAT YOU WILL LEARN</strong></h4>
