...
<div class="app-content content">
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <fieldset>
                <h4 class="card-title"><b>CHURCH</b></h4>
                <p>Please fill out information about your church below. You will be able to send your pastor a recommendation request on another page.</p>
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <h5>Church Name</h5>
                        <div class="form-group">
                            <input type="text" class="form-control white_bg" id="church_name" name="church_name" placeholder="Church Name" value="<?php echo isset($_SESSION['post']['church_name']) ? $_SESSION['post']['church_name'] : ''; ?>" required>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <h5>Church Address</h5>
                        <div class="form-group">
                            <textarea class="form-control white_bg" name="caddress" placeholder="Church Address" required><?php echo isset($_SESSION['post']['caddress']) ? $_SESSION['post']['caddress'] : ''; ?></textarea>
                        </div>
                    </div>
                </div>
                <a href="profile.php"><input type="button" class="btn btn-info mb-3" value="Previous" /></a>
                <input type="submit" name="submit" class="btn btn-info mb-3" value="Next" />
            </fieldset>
            </div>
                                </div>
                            </div>
