...
if (strlen($_SESSION['aid']) == 0) {
  ...
  $query = "SELECT tblfees.ID as feesid, tbladmapplications.programApplied, tbladmapplications.ID as apid, tbladmapplications.AdminStatus, tbluser.FirstName, tbluser.LastName, tbluser.MobileNumber, tbluser.Email 
