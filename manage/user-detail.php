    ...
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <form method="GET" action="user-detail.php">
                    <label for="degree">Select Degree Type:</label>
                    <select name="degree" id="degree" onchange="this.form.submit()">
                        <option value="">All</option>
                        <option value="undergraduate" <?php if($_GET['degree'] == 'undergraduate') echo 'selected'; ?>>Undergraduate</option>
                        <option value="postgraduate" <?php if($_GET['degree'] == 'postgraduate') echo 'selected'; ?>>Postgraduate</option>
                    </select>
                </form>
                <table class="table mb-0">
                    ...
                    if (isset($_GET['degree']) && $_GET['degree'] != "") {
                        $degree = $_GET['degree'];
                        $degree_filter = " WHERE tbluser.degree = '$degree'";
                    }
                    $ret = mysqli_query($con, "SELECT * FROM tbluser" . $degree_filter);
                    $cnt = 1;
